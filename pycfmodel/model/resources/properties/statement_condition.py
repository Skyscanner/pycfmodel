...
class StatementCondition(CustomModel):
    ...
    BinaryEquals: Annotated[Optional[Dict[str, ResolvableBytesOrList]], BeforeValidator(validate_binary)] = None
    BinaryEqualsIfExists: Annotated[Optional[Dict[str, ResolvableBytesOrList]], BeforeValidator(validate_binary)] = None
    ForAllValuesBinaryEquals: Annotated[
        Optional[Dict[str, ResolvableBytesOrList]], BeforeValidator(validate_binary)
    ] = None
    ForAllValuesBinaryEqualsIfExists: Annotated[
        Optional[Dict[str, ResolvableBytesOrList]], BeforeValidator(validate_binary)
    ] = None
    ForAnyValueBinaryEquals: Annotated[
        Optional[Dict[str, ResolvableBytesOrList]], BeforeValidator(validate_binary)
    ] = None
    ForAnyValueBinaryEqualsIfExists: Annotated[
        Optional[Dict[str, ResolvableBytesOrList]], BeforeValidator(validate_binary)
    ] = None
